...
export class ClientManager {
     ...
     */
    async getOrCreateClient(workspacePath, disableCodeAssist = false) {
     ...
     */
    async onWorkspaceChanged(newWorkspacePath) {
     ...
     */
    needsWorkspaceReinitialization(workspacePath) {
        // 如果没有现有容器，需要初始化
        if (!this.currentContainer) {
            return true;
        }
