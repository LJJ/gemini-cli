...
export class ServerBootstrap {
   ...
   * 获取预加载的默认工作区
   */
  public getDefaultWorkspace(): string | null {
   ...
   * 预加载最近使用的工作区
   */
  private async preloadRecentWorkspace(): Promise<void> {
    try {
      // 获取所有缓存的工作区
   ...
   * 初始化默认工作区
   */
  private async initializeDefaultWorkspace(workspacePath: string): Promise<void> {
    try {
